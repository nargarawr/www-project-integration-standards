...
class TestParsers(unittest.TestCase):
    ...
    def test_parse_uknown_key_val_spreadsheet(self):
        ...
        input = [collections.OrderedDict({'CS': 'Session Management', 'CWE': 598,
                 ...
                 collections.OrderedDict({'CS': 'Session Management', 'CWE': 384,
                                          ...
                                          'Top10': 'https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control',
                                          'WSTG': 'WSTG-SESS-03'})]
        expected = {'CS-Session Management': defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='',
                                                           name='CS', links=[defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='CWE', links=[], tags=[], metadata=defs.Metadata(labels=[]), section='598'),
                                                                             ...
                                                                             defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='Top10', links=[], tags=[
                                                                             ], metadata=defs.Metadata(labels=[]), section='https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control'),
                                                                             defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='WSTG', links=[
                                                                             ], tags=[], metadata=defs.Metadata(labels=[]), section='WSTG-SESS-04')
    ...
    def test_parse_v0_standards(self):
        ...
        expected = {'011-040-026': defs.CRE(doctype=defs.Credoctypes.CRE, name='011-040-026',
                                            description='Verify the application never reveals session tokens in URL parameters or error messages.',
                                            links=[
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='ASVS',
                                                              section='SESSION-MGT-TOKEN-DIRECTIVES-DISCRETE-HANDLING', subsection='3.1.1'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='CS',
                                                              section='Session Management'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='CWE',
                                                              section='598'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='Name',
                                                              section='Session'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='Top10 (lookup)',
                                                              section='https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='WSTG', section='WSTG-SESS-04')]),
                    '011-040-033': defs.CRE(doctype=defs.Credoctypes.CRE,   name='011-040-033',
                                            ...
                                            links=[
                                                ...
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='Name',
                                                              section='Session'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='OPC',
                                                              section='C6'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='Top10 (lookup)',
                                                              section='https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control'),
                                                defs.Standard(doctype=defs.Credoctypes.Standard, name='WSTG',
    ...
    def test_parse_v1_standards(self):
        input = [{'ASVS Item': 'V1.1.2', 'ASVS-L1': 'X', 'ASVS-L2': 'X', 'ASVS-L3': 'X', 'CORE-CRE-ID': '000-001',
        ...
        expected = ({'REQUIREMENTS': defs.CRE(doctype=defs.Credoctypes.CRE, id='654-390', description='', name='REQUIREMENTS',
                                                   links=[
                                                       defs.CRE(doctype=defs.Credoctypes.CRE, id='002-036', description='Verify the use of a secure software development lifecycle that addresses security in all stages of development. (C1)', name='SDLC_APPLY_CONSISTENTLY',
                                                                links=[
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='ASVS', links=[], tags=[
                                                                    ...
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='Cheatsheet', links=[], tags=[], section='Architecture, Design and Threat Modeling Requirements',
                                                                    ...
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[
                                                                    ], tags='is related to', section='RA-3 RISK ASSESSMENT,'),
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[
                                                                    ], tags='is related to', section='PL-8 SECURITY AND PRIVACY ARCHITECTURES'),
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='OPC', links=[
                                                                    ], tags=[], section='C1'),
                    ...
                    'SDLC_GUIDELINES_JUSTIFICATION': defs.CRE(doctype=defs.Credoctypes.CRE, id='925-827', description='', name='SDLC_GUIDELINES_JUSTIFICATION',
                                                                   links=[defs.CRE(doctype=defs.Credoctypes.CRE, id='000-001', description='desc', name='OTHER_CRE',
                                                                                   links=[defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='ASVS', links=[], tags=['L1', 'L2', 'L3'], metadata=defs.Metadata(labels=[]), section='V1.1.2', subsection='SDLC_GUIDELINES_JUSTIFICATION-REQUIREMENTS-RISK_ANALYSIS-THREAT_MODEL'),
                                                                                          defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='CWE', links=[
                                                                                          ], tags=[], metadata=defs.Metadata(labels=[]), section='0'),
                                                                                          defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[
                                                                                          ], tags='is related to', metadata=defs.Metadata(labels=[]), section='RA-3 RISK ASSESSMENT,'),
                                                                                          defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[], tags='is related to', metadata=defs.Metadata(labels=[]), section=''
                                                   ...
                                                   links=[
                                                       defs.CRE(doctype=defs.Credoctypes.CRE, id='002-036', description='Verify the use of a secure software development lifecycle that addresses security in all stages of development. (C1)', name='SDLC_APPLY_CONSISTENTLY',
                                                                links=[
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='ASVS', links=[], tags=[
                                                                        'L2', 'L3'], section='V1.1.1', subsection='SDLC_GUIDELINES_JUSTIFICATION-REQUIREMENTS-RISK_ANALYSIS-THREAT_MODEL'),
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard,
                                                                                  id='', description='', name='CWE', links=[], tags=[], section='0'),
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='', name='Cheatsheet', links=[], tags=[], section='Architecture, Design and Threat Modeling Requirements',
                                                                                  hyperlink='https: // cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html, https: // cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html, https: // cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html'),
                                                                    defs.Standard(doctype=defs.Credoctypes.Standard, id='', description='',
