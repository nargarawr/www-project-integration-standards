    ...
    def test_parse_uknown_key_val_spreadsheet(self):
        ...
        expected = {'CS-Session Management': defs.Standard(version=defs.CreVersions.V2, doctype=defs.Credoctypes.Standard, id='', description='',
                                                           name='CS', links=[defs.Standard(version=defs.CreVersions.V2, doctype=defs.Credoctypes.Standard, id='', description='', name='CWE', links=[], tags=[], metadata=defs.Metadata(labels=[]), section='598'),
                                                                             ...
                                                                             defs.Standard(version=defs.CreVersions.V2, doctype=defs.Credoctypes.Standard, id='', description='', name='Top10', links=[], tags=[
                                                                             ], metadata=defs.Metadata(labels=[]), section='https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control'),
                                                                             defs.Standard(version=defs.CreVersions.V2, doctype=defs.Credoctypes.Standard, id='', description='', name='WSTG', links=[
    ...
    def test_parse_v1_standards(self):
        ...
        expected = ({'REQUIREMENTS': defs.CreGroup(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Group, id='654-390', description='', name='REQUIREMENTS',
                    ...
                    'SDLC_GUIDELINES_JUSTIFICATION': defs.CreGroup(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Group, id='925-827', description='', name='SDLC_GUIDELINES_JUSTIFICATION',
                                                                   links=[defs.CRE(version=defs.CreVersions.V1, doctype=defs.Credoctypes.CRE, id='000-001', description='desc', name='OTHER_CRE',
                                                                                   links=[defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='ASVS', links=[], tags=['L1', 'L2', 'L3'], metadata=defs.Metadata(labels=[]), section='V1.1.2', subsection='SDLC_GUIDELINES_JUSTIFICATION-REQUIREMENTS-RISK_ANALYSIS-THREAT_MODEL'),
                                                                                          defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='CWE', links=[
                                                                                          ...
                                                                                          defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[], tags='is related to', metadata=defs.Metadata(labels=[]), section=''
