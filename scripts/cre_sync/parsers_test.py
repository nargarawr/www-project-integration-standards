        ...
        expected = ({'REQUIREMENTS': defs.CreGroup(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Group, id='654-390', description='', name='REQUIREMENTS',
                                                   links=[
                                                       defs.CRE(version=defs.CreVersions.V1, doctype=defs.Credoctypes.CRE, id='002-036', description='Verify the use of a secure software development lifecycle that addresses security in all stages of development. (C1)', name='SDLC_APPLY_CONSISTENTLY',
                                                        links=[
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='ASVS', links=[], tags=['L2', 'L3'], section='V1.1.1', subsection='SDLC_GUIDELINES_JUSTIFICATION-REQUIREMENTS-RISK_ANALYSIS-THREAT_MODEL'),
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='CWE', links=[], tags=[], section='0'),
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='Cheatsheet', links=[], tags=[], section='Architecture, Design and Threat Modeling Requirements', hyperlink='https: // cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html, https: // cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html, https: // cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html'),
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[], tags='is related to', section='RA-3 RISK ASSESSMENT,'),
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='NIST 800-53', links=[], tags='is related to', section='PL-8 SECURITY AND PRIVACY ARCHITECTURES'),
                                                                defs.Standard(version=defs.CreVersions.V1, doctype=defs.Credoctypes.Standard, id='', description='', name='OPC', links=[], tags=[], section='C1'), 
